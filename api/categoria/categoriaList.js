...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.categoriaRead);
        const payload = yield new categoriaService_1.default(req).findAndCountAll(req.query);
...
//# sourceMappingURL=categoriaList.js.map