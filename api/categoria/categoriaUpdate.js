...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.categoriaEdit);
        const payload = yield new categoriaService_1.default(req).update(req.params.id, req.body.data);
...
//# sourceMappingURL=categoriaUpdate.js.map