...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.categoriaDestroy);
        yield new categoriaService_1.default(req).destroyAll(req.query.ids);
        const payload = true;
...
//# sourceMappingURL=categoriaDestroy.js.map