...
class MarcaRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield marca_1.default(options.database).create([
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(marca_1.default(options.database).findOne({ _id: id, tenant: currentTenant.id }), options);
            if (!record) {
                throw new Error404_1.default();
            }
            yield marca_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield marca_1.default(options.database).deleteOne({ _id: id }, options);
            yield this._createAuditLog(auditLogRepository_1.default.DELETE, id, record, options);
            yield mongooseRepository_1.default.destroyRelationToOne(id, producto_1.default(options.database), 'marca', options);
        });
    }
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const records = yield marca_1.default(options.database)
                .find({
                _id: { $in: ids },
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(marca_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(marca_1.default(options.database)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.descripcion) {
                    criteriaAnd.push({
                        descripcion: {
                            $regex: mongooseQueryUtils_1.default.escapeRegExp(filter.descripcion),
                            $options: 'i',
                        },
                    });
                }
            ...
            const criteria = criteriaAnd.length
                ? { $and: criteriaAnd }
                : null;
            let rows = yield marca_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort);
            const count = yield marca_1.default(options.database).countDocuments(criteria);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield auditLogRepository_1.default.log({
                entityName: marca_1.default(options.database).modelName,
                entityId: id,
                action,
                values: data,
            }, options);
...
exports.default = MarcaRepository;
//# sourceMappingURL=marcaRepository.js.map